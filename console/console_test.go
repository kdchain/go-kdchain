...
func newTester(t *testing.T, confOverride func(*kd.Config)) *tester {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return kd.New(ctx, ethConf) }); err != nil {
