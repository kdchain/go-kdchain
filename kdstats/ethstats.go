...
type Service struct {
	...
	eth    *kd.Ethereum       // Full Ethereum service if monitoring a full node
...
func New(url string, ethServ *kd.Ethereum, lesServ *les.LightEthereum) (*Service, error) {
...
func (s *Service) login(conn *websocket.Conn) error {
	...
	if info := infos.Protocols["eth"]; info != nil {
		...
		protocol = fmt.Sprintf("eth/%d", kd.ProtocolVersions[0])
	} else {
